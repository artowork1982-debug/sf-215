    ...
    $definitions = [
        ...
        'pending_review' => [
            ...
            'labels' => [
                ...
                'en' => 'Pending review',
                'it' => 'In revisione',
                'el' => 'Σε αναμονή αξιολόγησης',
            ],
            'descriptions' => [
                'fi' => 'Tiedote odottaa vastuuhenkilön tarkistusta.',
                'sv' => 'Meddelandet väntar på ansvarig persons granskning.',
                'en' => 'Flash is awaiting responsible person’s review.',
                'it' => 'La segnalazione è in attesa della revisione del responsabile.',
                'el' => 'Το δελτίο αναμένει έλεγχο από τον υπεύθυνο.',
            ],
