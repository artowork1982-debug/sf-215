 ...
 * 
 * Format: SF_YYYY_MM_DD_TYPE_Worksite_lang.jpg
 * Example: SF_2026_01_11_RED_Kevitsa_fi.jpg
 * 
 * @param array $flash Flash data with keys: type, site, occurred_at/created_at, lang
 * @param int $cardNumber Optional card number for multi-card flashes (1 or 2)
 * @return string Filename like "SF_2026_01_11_RED_Kevitsa_fi.jpg"
 */
