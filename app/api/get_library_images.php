...
while ($row = $result->fetch_assoc()) {
    ...
    if ($filename !== '' && file_exists($basePath . 'uploads/library/' . $filename)) {
        $url = '/uploads/library/' . $filename;
    } elseif ($filename !== '' && file_exists($basePath . 'uploads/images/' . $filename)) {
        $url = '/uploads/images/' . $filename;
    } else {
        $url = '/uploads/library/' . $filename; // fallback
    }
